...
namespace GameStateManagement
{
    ...
    class BooleanButton : Button
    {
        ...
        public BooleanButton(bool value, Vector2 position)
            : base(position)
        {
            this.value = value;
        ...
        {
            Text = string.Format("{0}", value ? "On" : "Off");
        }
    }
    ...
    class Button
    {
        ...
        /// </summary>
        public Color FillColor = new Color(90, 90, 90) * .8f;
        ...
        public Button(string text, Vector2 size, Vector2 position, Color couleur_fond, Color couleur_bordure, Color couleur_texte)
        {
            Text = text;
            Size = size;
            Position = position;

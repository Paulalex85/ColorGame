...
namespace GameStateManagement
{
    ...
    {
        #region Fields
        const int menuEntryPadding = 20;
        int _positionTitreHeight = 100;
        int _espace_entre_entry = 30;
        ...
        public MenuScreen(Texture2D textureTitle)
        {
            EnabledGestures = GestureType.Tap;

            this.textureTitle = textureTitle;
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            for (int i = 0; i < menuEntries.Count; i++)
            {
                ...
                position.Y += menuEntry.GetHeight(this) + _espace_entre_entry;
            }
        }

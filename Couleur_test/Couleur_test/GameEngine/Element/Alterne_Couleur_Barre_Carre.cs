...
{
    class Alterne_Couleur_Barre_Carre : Element
    {
        int _id_carre;
        ...
        public Alterne_Couleur_Barre_Carre(int parametre, int id_carre)
        ...
        public override void UpdateElement(float timer, List<Carre> liste_carre, Objectif_ligne ligne_objectif, List<Element> list_element, List<Color> list_couleur, GameScreen screen)
        {
            ...
            if (_timer_changement.IncreaseTimer(timer))
            {
                ...
                foreach (Objectif_Carre_Ligne caca in ligne_objectif.objectif_liste_ligne)
                {
                    if (caca._identifiant == id_a)
                    {
                        caca._couleur = d;
                    }
                    else if (caca._identifiant == id_b)
                    {
                        caca._couleur = c;
                    }
                }
